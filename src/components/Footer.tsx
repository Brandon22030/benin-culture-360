      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="md:col-span-1">
            ...
            <p className="mt-4 text-sm text-gray-400">
              Explorez la richesse culturelle du Bénin à travers notre
              plateforme interactive dédiée au patrimoine béninois.
            </p>
            <div className="flex mt-6 space-x-4">
              <a
                href="#"
                className="text-gray-400 hover:text-benin-yellow transition-colors"
              >
                <Facebook size={20} />
              </a>
              <a
          ...
          <div>
            ...
            <p className="text-sm text-gray-400 mb-4">
              Abonnez-vous pour recevoir les dernières actualités sur la culture
              béninoise.
            </p>
            <div className="flex">
              <input
        ...
        <div className="border-t border-gray-800 mt-10 pt-6 flex flex-col md:flex-row justify-between items-center">
          ...
          <div className="flex space-x-6 mt-4 md:mt-0">
            <Link
              to="/privacy"
              className="text-sm text-gray-400 hover:text-benin-yellow transition-colors"
            >
