...
const QuizPage = () => {
  ...
  const startQuiz = useCallback(async () => {
    setIsLoading(true);
    try {
      const generatedQuestions = await generateQuizQuestionsFromAI(
        10,
        difficulty,
        true,
      );
            ...
            {quizState === "start" && (
              <Card className="shadow-lg">
                <CardHeader className="text-center">
                  <CardTitle className="text-3xl md:text-4xl font-bold font-title">
                    Quiz Culturel du Bénin
                  </CardTitle>
                  <CardDescription className="text-lg">
                    Testez vos connaissances sur la culture, l'histoire et les
                    traditions du Bénin
                  </CardDescription>
                </CardHeader>
                <CardContent className="space-y-6">
                  <div className="bg-benin-green/10 rounded-lg p-4 text-benin-green">
                    ...
                    <ul className="list-disc list-inside text-sm space-y-1">
                      <li>
                        Le quiz comporte 10 questions générées par intelligence
                        artificielle
                      </li>
                      <li>
                      ...
                      <li>
                        Votre score final dépendra du nombre de bonnes réponses
                        et de la difficulté des questions
                      </li>
                    </ul>
                  </div>
            ...
            {quizState === "question" && currentQuestion && (
              <div className="space-y-6">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    <span
                      className={`font-medium ${timer <= 10 ? "text-benin-red" : "text-gray-700"}`}
                    >
                      {timer}s
                    </span>
              ...
              <Card className="shadow-lg">
                ...
                <CardContent className="space-y-6">
                  <div className="flex flex-col items-center">
                    <div className="w-32 h-32 rounded-full bg-benin-green/10 flex items-center justify-center mb-4">
                      <div className="text-center">
                        <span className="text-4xl font-bold text-benin-green">
                          {score}
                        </span>
                        <span className="text-xl text-benin-green">
                          /{totalQuestions}
                        </span>
                      </div>
                    </div>
                  ...
                  <div className="bg-benin-green/10 rounded-lg p-4 text-benin-green">
                    ...
                    <ul className="list-disc list-inside text-sm space-y-1">
                      <li>
                        Visitez la section Carte pour découvrir les spécificités
                        culturelles de chaque région
                      </li>
                      <li>
                        Consultez notre galerie multimédia pour vous
                        familiariser avec les arts et traditions
                      </li>
                      <li>
                        Écoutez notre bibliothèque audio pour mieux comprendre
                        les sons du Bénin
                      </li>
                      <li>
                        Rejouer le quiz pour tester à nouveau vos connaissances
                      </li>
                    </ul>
                  </div>
                </CardContent>
