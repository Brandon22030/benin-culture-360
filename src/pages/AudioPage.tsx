...
const AudioPage = () => {
  ...
  const categories = Array.from(
    new Set(audioTracks.map((track) => track.category)),
  );
  const filteredTracks = selectedCategory
    ? audioTracks.filter((track) => track.category === selectedCategory)
    : audioTracks;
  const currentTrackData = audioTracks.find(
    (track) => track.id === currentTrack,
  );
  const detailsTrackData = audioTracks.find(
    (track) => track.id === trackDetails,
  );
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center mb-12">
            <h1 className="text-3xl md:text-4xl font-bold font-title mb-6">
              Bibliothèque Audio Béninoise
            </h1>
            <p className="text-lg text-gray-600">
              Immergez-vous dans les sons et musiques traditionnelles du Bénin,
              des percussions aux chants rituels.
            </p>
          </div>
            ...
            <Button
              ...
              className={
                selectedCategory === null
                  ? "bg-benin-red hover:bg-benin-red/90"
                  : ""
              }
                  ...
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h3 className="text-2xl font-semibold">
                        {detailsTrackData?.title}
                      </h3>
                      <p className="text-benin-red">
                        {detailsTrackData?.artist}
                      </p>
                    </div>
                    <Button
                      variant="ghost"
                      ...
                      <div className="flex items-center gap-4 mb-6">
                        ...
                        <div className="w-2/3 space-y-3">
                          ...
                          <div className="flex items-center gap-2">
                            ...
                            <span className="text-sm text-gray-600">
                              {detailsTrackData?.region
                                ? `Région: ${detailsTrackData.region}`
                      ...
                      {detailsTrackData?.context ? (
                        <>
                          <p className="text-gray-600 italic">
                            {detailsTrackData.context.introduction ||
                        ...
                        <p className="text-gray-600 italic">
                          Informations contextuelles non disponibles pour cette
                          pièce musicale.
                        </p>
                      )}
                    </TabsContent>
